...
const defaultAPI: ColorPickTooltipAPI = { addColorPicker: () => undefined, removeColorPicker: () => undefined };
...
export const defaultColorOptions: ColorOptions[] = [
  {
    ...
    items: [
      ...
      { label: 'Red', value: '#fed5d5' },
      { label: 'Orange', value: '#fedfbb' },
      { label: 'Yellow', value: '#fef3a1' },
      { label: 'Green', value: '#e1fab1' },
      { label: 'Teal', value: '#adf8e9' },
      { label: 'Blue', value: '#cce2fe' },
      { label: 'Purple', value: '#edddff' },
      { label: 'Grey', value: '#eaecef' },
    ],
  },
];
